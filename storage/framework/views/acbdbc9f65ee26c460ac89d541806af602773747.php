...
<html lang="en" class=" js no-touch csstransforms csstransitions"><!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="http://www.ansonika.com/annova/img/favicon.ico" type="image/x-icon">
    ...
    <body>
        <?php echo $__env->make('ui.blocks.popup-send-mail', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        />
        <section id="top-area">
            <?php echo $__env->make('ui.blocks.menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
