<li class="title-question animated zoomIn row question<?php echo e($number); ?>" question="<?php echo e($number); ?>">
    <div>
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="img-trash row">
                    ...
                    <a class="glyphicon glyphicon-trash col-md-1" id-question="<?php echo e($number); ?>"></a>
