                ...
                <div class="row">
                    <div class="col-md-4 complete-info">
                        ...
                        <div class="fb-share-button"
                            data-href="<?php echo e(action('AnswerController@answerPublic', $token)); ?>"
                            data-layout="button_count"
                            data-size="small"
                            data-mobile-iframe="true">
                            <a class="fb-xfbml-parse-ignore" target="_blank" href="<?php echo e(action('AnswerController@answerPublic', $token)); ?>">
                                <?php echo e(trans('survey.share')); ?>sdsadsd
                            </a>
                        </div>
                    </div>
