...
<div class="content">
    <div class="register">
        ...
        <div class="body">
            <p>You have been invited to participant this survey.</p>
            <p><?php echo e(trans('messages.email.from')); ?> <?php echo e($email); ?> ( <?php echo e($senderName); ?> )
        <hr>
        </div>
        <div class="content-survey">
            <p>Title: <?php echo e($survey->title); ?></p>
            <p>Description: <?php echo e($survey->description); ?></p>
            <div class="hr-heading-body">
                <p>Let's click link below to participant.</p>
