    ...
    <div id="survey_container" class="survey_container animated zoomIn wizard" novalidate="novalidate">
        ...
        <?php echo Form::open([
            ...
            <div id="middle-wizard" class="wizard-branch wizard-wrapper">
                ...
                <?php endif; ?>
                <?php echo $__env->make('ui.steps.step-infor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo $__env->make('ui.steps.step-create-survey', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo $__env->make('ui.steps.step-send-mail', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo $__env->make('ui.steps.step-finish', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
