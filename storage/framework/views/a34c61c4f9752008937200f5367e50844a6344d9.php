    ...
    <div id="survey_container" class="survey_container animated zoomIn wizard" novalidate="novalidate">
        ...
        <?php echo Form::open([
            ...
            <div id="middle-wizard" class="wizard-branch wizard-wrapper">
                ...
                <?php echo $__env->make('user.steps.step-setting', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div id="bottom-wizard">
                <?php echo Form::button(trans('home.back'), [
                    'class' => 'backward',
                    'disabled' => 'disabled',
                ]); ?>

                <?php echo Form::button(trans('home.next'), [
                    'class' => 'forward ',
                    'disabled' => 'disabled',
                ]); ?>
