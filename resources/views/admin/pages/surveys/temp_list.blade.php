<div class="row" id="survey-list">
    ...
    {!! Form::open(['action' => 'Admin\SurveyController@changeFeature']) !!}
        ...
        {!! Form::button(trans('admin.change_feature'),['class' => 'btn btn-primary','id' => 'changeFeature']) !!}
        {!! Form::close() !!}
    </div>
    <div class="col-md-12">
        ...
        {!! Form::button(trans('admin.update_feature'), ['class' => 'btn btn-primary', 'id' => 'updateFeature']) !!}
        {!! Form::close() !!}
    </div>
</div>
