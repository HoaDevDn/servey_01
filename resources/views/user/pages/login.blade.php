                                ...
                                <li class="social-li" >
                                    <div>
                                        <ul class="data-list social-bookmarks clearfix">
                                            <li class="facebook">
                                                <a href="{{ action('User\SocialAuthController@redirect', ['facebook']) }}">
                                                </a>
                                            </li>
                                            <li class="googleplus">
                                                <a href="{{ action('User\SocialAuthController@redirect', ['google']) }}">
                                                </a>
                                            </li>
                                            <li class="twitter">
                                                <a href="{{ action('User\SocialAuthController@redirect', ['twitter']) }}">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
